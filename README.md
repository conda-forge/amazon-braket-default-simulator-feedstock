About amazon-braket-default-simulator-feedstock
===============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/amazon-braket-default-simulator-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/amazon-braket-default-simulator-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add amazon-braket-default-simulator
# for installing globally
pixi global install amazon-braket-default-simulator
```
...
It is possible to list all of the versions of `amazon-braket-default-simulator` available on your platform:
...
```
pixi search amazon-braket-default-simulator --channel conda-forge
```
